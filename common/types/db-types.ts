...
export type RoomType = {
  readonly id: string; // UUID generated by backend
  readonly beds: number; // >= 1, integer
  readonly baths: number; // >= 1, integer
...
export type Apartment = {
  ...
  readonly roomTypes: readonly RoomType[]; // can be empty array
  readonly photos: readonly string[]; // can be empty
