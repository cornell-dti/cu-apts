  ...
  return (
    <Container maxWidth="lg">
      ...
      <Typography variant="body2" className={body}>
        Your privacy is important to us. It is CU Apartments&#39; policy to respect your privacy and
        ...
        <a className={link} href="https://cuapts.org" target="_blank" rel="noreferrer">
          https://cuapts.org
        </a>
